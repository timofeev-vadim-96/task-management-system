...
--changeset timofeev_vadim:2025-01-15--testData
...
VALUES ('Task 1', 'Description 1', 'ВЫСОКИЙ', 'В_ОЖИДАНИИ', 1, 2),
       ('Task 2', 'Description 2', 'СРЕДНИЙ', 'В_ПРОЦЕССЕ', 1, 3),
       ('Task 3', 'Description 3', 'НИЗКИЙ', 'ЗАВЕРШЕНО', 1, 4),
       ('Task 4', 'Description 4', 'ВЫСОКИЙ', 'В_ОЖИДАНИИ', 1, 5),
       ('Task 5', 'Description 5', 'СРЕДНИЙ', 'В_ПРОЦЕССЕ', 1, 6),
       ('Task 6', 'Description 6', 'НИЗКИЙ', 'ЗАВЕРШЕНО', 1, 7),
       ('Task 7', 'Description 7', 'ВЫСОКИЙ', 'В_ОЖИДАНИИ', 1, 8),
       ('Task 8', 'Description 8', 'СРЕДНИЙ', 'В_ПРОЦЕССЕ', 1, 9),
       ('Task 9', 'Description 9', 'НИЗКИЙ', 'ЗАВЕРШЕНО', 1, 10),
       ('Task 10', 'Description 10', 'ВЫСОКИЙ', 'В_ОЖИДАНИИ', 1, 2);
